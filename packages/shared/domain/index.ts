export * from './entities/Empresa.js'
export * from './entities/Entidade.js'
export * from './entities/Funcionario.js'
...
export * from './valueObjects/Nif.js'
export * from './valueObjects/Password.js'
export * from './valueObjects/Username.js'
